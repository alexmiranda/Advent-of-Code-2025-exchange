...
public class Y23GUIOutput3D25 extends Application {

	static Y23GUIOutput3D25 instance = null;
	...
	public Y23GUIOutput3D25(String title, boolean useCachedNodes) {
		this.title = title;
...
//		currentScene.getChildren().add(text3D);
	...
	public static void main(String[] args) throws Exception {
		Y23GUIOutput3D25 output = new Y23GUIOutput3D25("GUIOutput3D Test", true);
		output.smaller();
